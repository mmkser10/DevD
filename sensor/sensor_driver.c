...
/*
    ...
    if (green < 7000 && blue < 7000 && red > 12000) { printk("red\n"); }
    else if (green > 12000 && blue < 12000 && red < 12000) { printk("green\n"); }
    else if (green < 7000 && blue > 12000 && red < 7000) { printk("blue\n"); }
    else if (green > 10000 && blue > 10000 && red > 10000) { printk("object not found\n"); }
    else printk("anothor color\n");
